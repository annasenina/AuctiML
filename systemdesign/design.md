...
Проект будет считаться успешным при соблюдении следующих условий:
 - Уровень ошибки в предсказании рыночной цены объекта (MAPE/MDAPE) не превышает - 5-10% 
 - Верно определена ликвидность объекта. Модель при threshold = 0.8 успешно определяет ликвидность объекта не меньше чем в 85% случаях.
 - Интерпретируемость является достаточной и полной для принятия решения о приобретении объекта.
...
Проект будет считаться успешным при соблюдении следующих условий:
1. Уровень ошибки в предсказании рыночной цены объекта (MAPE/MDAPE) не превышает - 5-10% 
2. Верно определена ликвидность объекта. Модель при threshold = 0.8 успешно определяет ликвидность объекта не меньше чем в 85% случаях.
